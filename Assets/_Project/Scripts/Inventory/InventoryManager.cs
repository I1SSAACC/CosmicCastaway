    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyCode.I))
        {
            ...
            if (isOpened)
            {
                ...
                CVC.GetCinemachineComponent<CinemachinePOV>().m_HorizontalAxis.m_MaxSpeed = 0f;
                CVC.GetCinemachineComponent<CinemachinePOV>().m_VerticalAxis.m_MaxSpeed = 0f;
            ...
            else
            {
                ...
                CVC.GetCinemachineComponent<CinemachinePOV>().m_HorizontalAxis.m_MaxSpeed = 0.1f;
                CVC.GetCinemachineComponent<CinemachinePOV>().m_VerticalAxis.m_MaxSpeed = 0.1f;
                // Прекрепляем курсор к середине экрана
